...
function setMinMax() {
    ...
    // (I know all the code but one action listener was supposed to be in functions but I couldn't get this part to work without having it run on load. It doesn't change the functionality at all.)
