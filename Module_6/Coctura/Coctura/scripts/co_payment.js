...
window.addEventListener("load", function() {
   ...
   formData = formData.replace(/\+/g, " "); // Globally replace '+' with ' '
   formData = decodeURIComponent(formData); // Decoding %24 to '$', %28 to '(', etc.
   var formField = formData.split(/[&=]/g); // Split the form at every '&' or '='
...
function luhn(idNum) {
   ...
   // Return whether the sum of the digits is evenly divisible by 10
